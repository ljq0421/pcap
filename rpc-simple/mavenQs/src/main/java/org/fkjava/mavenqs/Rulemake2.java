...
@Service
@ServerEndpoint(value = "/rule_make2")
@Component
public class Rulemake2 {// implements HelloService {
    ...
    private static CopyOnWriteArraySet<Rulemake2> webSocketSet = new CopyOnWriteArraySet<Rulemake2>();
    ...
    public void onMessage(String message, Session session) throws Exception {
        ...
        String COMMAND2 = "python /root/pcap/define2.py ";
        if(message.equals("open") || message.equals("close")){//时间戳、规则名、对象、info、状态
            try{
