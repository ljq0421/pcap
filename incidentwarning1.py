...
if incidenttype=="incident-ssh":#ssh报警：源ip、目的ip、端口（默认22）、方向（进/出）、类型（记录/报警）
    ...
    while True:
        ...
        if(sshtype=="ssh-happen"):#发生即记录，不论方向
            query = "select * from protocol where type='SSH' and info='SYN first' and name='" + project_id + "' and id>" + str(idmax1)+"  and (src_ip='"+ip+"'"+" or dst_ip='"+ip+"') and (src_port='"+sshport+"'"+" or dst_port='"+sshport+"')"
            ...
            cursori.execute("insert into past (ruleid,project_id,project_name,display_name,timestamp,proto,src_ip,src_port,src_mac,dst_ip,dst_port,dst_mac,type,info) "
                                "values ('"+ruleid+"','"+project_id+"','"+project_name+"','"+ruleobject+"','"+result[0][1]+"','"+result[0][2]+"','"+result[0][3]+"','"
                                +result[0][4]+"','"+result[0][7]+"','"+result[0][5]+"','"+result[0][6]+"','"+result[0][8]+"','"+result[0][10]+"','"+result[0][11]+"')")
            print "insert into past (ruleid,project_id,project_name,display_name,timestamp,proto,src_ip,src_port,src_mac,dst_ip,dst_port,dst_mac,type,info) values ('"+ruleid+"','"+project_id+"','"+project_name+"','"+ruleobject+"','"+result[0][1]+"','"+result[0][2]+"','"+result[0][3]+"','"+result[0][4]+"','"+result[0][7]+"','"+result[0][5]+"','"+result[0][6]+"','"+result[0][8]+"','"+result[0][10]+"','"+result[0][11]+"')"
            db_ins.commit()
            #sys.stdout.flush()
            ...
            if(sshdir=="ssh-in"):#禁止本虚拟机作为ssh的目的地址,源地址是sshsip
                query = "select * from protocol where type='SSH' and info='SYN first' and name='" + project_id + "' and id>" + str(idmax1)+"  and dst_ip='"+ip+"'"+" and src_ip='"+sshsip+"' and (src_port='"+sshport+"'"+" or dst_port='"+sshport+"')"
                cursort.execute(query)
                print query
                #sys.stdout.flush()
                db_test.commit()
                ...
                strr = 'curl -H "Content-Type: application/json" -XPOST \'10.10.87.23:9200/protocol/external/' + str(
                    result[0][0]) + '?pretty\' -d\' {"timestamp":"' + result[0][1] + '","protocol":"' + result[0][
                       ...
                       result[0][5] + '","dst_port":"' + result[0][6] + '","src_mac":"' + result[0][
                           7] + '","dst_mac":"' + result[0][8] + '","UID":"' + result[0][9] + '","typee":"' + result[0][
                           10] + '","info":"' + result[0][11] + '","state":"' + state + '"}\''
                print strr
                os.system(strr)
                ...
                query = "select * from protocol where type='SSH' and info='SYN first' and name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + sshdip + "'" + " and src_ip='" + ip + "' and (src_port='"+sshport+"'"+" or dst_port='"+sshport+"')"
                cursort.execute(query)
                print query
                #sys.stdout.flush()
                db_test.commit()
    ...
    while True:
        ...
        if(dbtype=="db-happen"):#发生即记录，不论方向
            query = "select * from protocol where name='" + project_id + "' and id>" + str(idmax1)+"  and (src_ip='"+ip+"'"+" or dst_ip='"+ip+"') and (src_port='"+dbport+"'"+" or dst_port='"+dbport+"') and info like '%"+dbstate+"%'"
            cursort.execute(query)
            print query
            #sys.stdout.flush()
            db_test.commit()
            ...
            cursori.execute(
                ...
                "values ('" + ruleid + "','" + project_id + "','" + project_name + "','" + ruleobject + "','" +
                result[0][1] + "','" + result[0][2] + "','" + result[0][3] + "','"
                + result[0][4] + "','" + result[0][7] + "','" + result[0][5] + "','" + result[0][6] + "','" + result[0][
                    8] + "','" + result[0][10] + "','" + result[0][11] + "')")
            print "insert into past (ruleid,project_id,project_name,display_name,timestamp,proto,src_ip,src_port,src_mac,dst_ip,dst_port,dst_mac,type,info) values ('" + ruleid + "','" + project_id + "','" + project_name + "','" + ruleobject + "','" + \
                  result[0][1] + "','" + result[0][2] + "','" + result[0][3] + "','" + result[0][4] + "','" + result[0][
                      7] + "','" + result[0][5] + "','" + result[0][6] + "','" + result[0][8] + "','" + result[0][
                      10] + "','" + result[0][11] + "')"
            db_ins.commit()
            #sys.stdout.flush()
            ...
            if(dbdir=="db-in"):#禁止本虚拟机作为db的目的地址,源地址是dbsip
                query = "select * from protocol where name='" + project_id + "' and id>" + str(idmax1)+"  and dst_ip='"+ip+"'"+" and src_ip='"+dbsip+"' and (src_port='"+dbport+"'"+" or dst_port='"+dbport+"') and info like '%"+dbstate+"%'"
                cursort.execute(query)
                print query
                #sys.stdout.flush()
                db_test.commit()
                ...
                #sys.stdout.flush()
                os.system('echo "DB!!!!"|mail -s "warning-DB" ' + mail)
            elif (sshdir == "db-out"):  # 禁止本虚拟机作为db的源地址,目的地址是dbdip
                query = "select * from protocol where name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + dbdip + "'" + " and src_ip='" + ip + "' and (src_port='"+dbport+"'"+" or dst_port='"+dbport+"') and info like '%"+dbstate+"%'"
                cursort.execute(query)
                print query
                #sys.stdout.flush()
                db_test.commit()
    ...
    while True:
        ...
        if (scantype == "scan-happen"):  # 发生即记录，不论方向
            time.sleep(30)
            query = "select distinct dst_port from protocol where name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + ip + "')"
            cursort.execute(query)
            print query
            #sys.stdout.flush()
            db_test.commit()
            ...
            if len(result) > 50:
                ...
                query = "update protocol set state='scan-record' where name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + ip + "')"
                print query
                cursort.execute(query)
                db_test.commit()
            ...
            if (scandir == "scan-in"):  # 禁止本虚拟机作为scan的目的地址,源地址是scansip
                time.sleep(30)
                query = "select distinct dst_port from protocol where name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + scandip + "'" + " and src_ip='" +scansip + "'"
                cursort.execute(query)
                print query
                #sys.stdout.flush()
                db_test.commit()
                ...
                if len(result) > 50:
                    ...
                    query = "update protocol set state='scan-warn' where name='" + project_id + "' and id>" + str(idmax1) + "  and dst_ip='" + ip + "')"
                    print query
                    cursort.execute(query)
                    db_test.commit()
                    ...
                    strr = 'curl -H "Content-Type: application/json" -XPOST \'10.10.87.23:9200/protocol/external/' + str(
                        result[0][0]) + '?pretty\' -d\' {"timestamp":"' + result[0][1] + '","protocol":"' + result[0][
                               2] + '","src_ip":"' + result[0][3] + '","src_port":"' + result[0][4] + '","dst_ip":"' + \
                           result[0][5] + '","dst_port":"' + result[0][6] + '","src_mac":"' + result[0][
                               7] + '","dst_mac":"' + result[0][8] + '","UID":"' + result[0][9] + '","typee":"' + \
                           result[0][10] + '","info":"' + result[0][11] + '","state":"' + state + '"}\''
                    print strr
                    os.system(strr)
    ...
    if(dostype=='icmp' or dostype=='smurf' or dostype=='udp' or dostype=='fraggle' ):
        ...
        while True:
            ...
            idmax0 = cursort.fetchone()
            idmax1 = int(str(idmax0)[1:-3])
            query = "select * from protocol where proto='" + proto + "' and name='" + project_id + "' and id>" + str(idmax1) + "  and (src_ip='" + ip + "'" + " or dst_ip='" + ip + "')"
            cursort.execute(query)
            print query
            #sys.stdout.flush()
            db_test.commit()
            ...
            if len(result) != 0:
                ...
                if lianxu >= 100000:
                    ...
                    query = "update protocol set state='dos-"+dostype+"-warn' where proto='" + proto + "' and name='" + project_id + "' and id>" + str(idmax1) + "  and (src_ip='" + ip + "'" + " or dst_ip='" + ip + "')"
                    print query
                    cursort.execute(query)
                    db_test.commit()
        ...
        while True:
            ...
            idmax0 = cursort.fetchone()
            idmax1 = int(str(idmax0)[1:-3])
            query = "select * from protocol where (info like 'SYN%' or info like 'SYN') and name='" + project_id + "' and id>" + str(idmax1)+"  and (src_ip='"+ip+"'"+" or dst_ip='"+ip+"')"
            cursort.execute(query)
            print query
            #sys.stdout.flush()
            db_test.commit()
    ...
    while True:
        ...
        if (ftptype == "ftp-happen"):  # 发生即记录，不论方向
            query = "select * from protocol where type='FTP' and info like '%"+ftptypee+"%' and name='" + project_id + "' and id>" + str(
                idmax1) + "  and (src_ip='" + ip + "'" + " or dst_ip='" + ip + "') and (src_port='" + ftpport + "'" + " or dst_port='" + ftpport + "')"
            cursort.execute(query)
            print query
            # sys.stdout.flush()
            db_test.commit()
            ...
            query = "update protocol set state='ftp-happen' where id="+str(result[0][0])
            print query
            cursort.execute(query)
            db_test.commit()
            ...
            if (ftpdir == "ftp-in"):  # 禁止本虚拟机作为ssh的目的地址,源地址是sshsip
                query = "select * from protocol where type='FTP' and info like '%"+ftptypee+"%' and name='" + project_id + "' and id>" + str(
                    idmax1) + "  and dst_ip='" + ip + "'" + " and src_ip='" + ftpsip + "' and (src_port='" + ftpport + "'" + " or dst_port='" + ftpport + "')"
                cursort.execute(query)
                print query
                # sys.stdout.flush()
                db_test.commit()
                ...
                query = "select * from protocol where type='FTP' and info like '%"+ftptypee+"%' and name='" + project_id + "' and id>" + str(
                    idmax1) + "  and dst_ip='" + ftpdip + "'" + " and src_ip='" + ip + "' and (src_port='" + ftpport + "'" + " or dst_port='" + ftpport + "')"
                cursort.execute(query)
                print query
                # sys.stdout.flush()
                db_test.commit()
    ...
    while True:
        ...
        if (httptype == "http-happen"):  # 发生即记录，不论方向
            query = "select * from protocol where type='HTTP' and info like '%" + httptypee + "%' and name='" + project_id + "' and id>" + str(
                idmax1) + "  and (src_ip='" + ip + "'" + " or dst_ip='" + ip + "') and (src_port='" + httpport + "'" + " or dst_port='" + httpport + "')"
            cursort.execute(query)
            print query
            # sys.stdout.flush()
            db_test.commit()
            ...
            query = "update protocol set state='http-happen' where id=" + str(result[0][0])
            print query
            cursort.execute(query)
            db_test.commit()
            ...
            if (httpdir == "http-in"):  # 禁止本虚拟机作为ssh的目的地址,源地址是sshsip
                query = "select * from protocol where type='HTTP' and info like '%" + httptypee + "%' and name='" + project_id + "' and id>" + str(
                    idmax1) + "  and dst_ip='" + ip + "'" + " and src_ip='" + httpsip + "' and (src_port='" + httpport + "'" + " or dst_port='" + httpport + "')"
                cursort.execute(query)
                print query
                # sys.stdout.flush()
                db_test.commit()
                ...
                query = "select * from protocol where type='HTTP' and info like '%" + httptypee + "%' and name='" + project_id + "' and id>" + str(
                    idmax1) + "  and dst_ip='" + httpdip + "'" + " and src_ip='" + ip + "' and (src_port='" + httpport + "'" + " or dst_port='" + httpport + "')"
                cursort.execute(query)
                print query
                # sys.stdout.flush()
                db_test.commit()
