...
BuildArch:	noarch
Group:		System/Kernel
Requires: 	dkms >= 1.95, pfring = 7.3.0
AutoReqProv: 	no
...
GIT info: dev:4ba4ffbebbca5781af789e7a5fbf297069d6c361 (Fri Oct 12 10:36:15 2018 +0200)
...
case "$1" in
	...
	\/bin/rm -f /lib/modules/$kernel/weak-updates/pf_ring.ko
	\/bin/rm -f /lib/modules/$kernel/extra/pf_ring.ko
